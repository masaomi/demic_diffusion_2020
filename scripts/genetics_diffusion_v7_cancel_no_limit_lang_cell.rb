...
$generation.times do |gi|
  ...
  warn2 "# generation: #{gi+1}, human pop size: #{human_cells.total_size}, crop pop size: #{crop_cells.total_size}; lang pop size: #{lang_cells.total_size}"
